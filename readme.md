...
이 프로젝트는 Django를 활용하여 할 일(To-Do) 관리 기능을 제공하는 웹 애플리케이션입니다. REST API와 사용자 인증 기능을 포함하며, Docker 및 Docker Compose를 사용하여 MySQL 데이터베이스와 Django 애플리케이션을 컨테이너화했습니다.

본 프로젝트는 **개발자로서의 역량**을 보여주기 위한 포트폴리오 용도로 개발되었으며, 컨테이너 기반 개발과 배포 환경 구축 경험을 중점적으로 다룹니다.
